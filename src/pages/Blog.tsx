  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="bg-secondary/20 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-foreground mb-4">Community Blog</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {loading ? <div className="text-center py-12">
            ...
            {posts.map(post => <Card key={post.id} className="group overflow-hidden hover-scale transition-all duration-300 hover:shadow-xl border-0 shadow-lg bg-card flex flex-col">
                {/* Featured Image */}
                {post.featured_image && <div className="aspect-video overflow-hidden">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  {/* Excerpt */}
                  {post.excerpt && <p className="text-sm text-muted-foreground leading-relaxed mb-4 line-clamp-3 flex-grow">
                      {post.excerpt}
                    </p>}
